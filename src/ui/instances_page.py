...
class InstancesPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        delay_label.setStyleSheet("padding: 10px; color: white; border-radius: 10px; background-color: #2a2c3e;")
        ...
        self.monitor_combo.setFixedWidth(100)
        ...
        self.cols_spin.setFixedWidth(100)
